...
txtHeader.SetHeader("#bf{CMS Preliminary}          2.8 fb^{-1} (13 TeV)")
#txtHeader.Draw()
...
l_CMSLumi.SetHeader("2.8 fb^{-1} (13 TeV)")
...
mGammaD_GeV_top = 30.0 # high boundary where histograms stops in m
...
def plot_BR_GammaD_to_2mu():
  ...
  for m in fRange(0.25, 30.0, 1000):
...
def limit_CSxBR2_fb_vs_ma_2015():
  ...
  os.system("convert -define pdf:use-cropbox=true -density 300 plots/PDF/CSxBR_vs_ma_2015.pdf -resize 900x900 plots/PNG/CSxBR_vs_ma_2015.png")
...
#  l_CMS.Draw()
  ...
  os.system("convert -define pdf:use-cropbox=true -density 300 plots/PDF/CSxBR_NMSSM_vs_mh_2015.pdf -resize 900x900 plots/PNG/CSxBR_NMSSM_vs_mh_2015.png")
